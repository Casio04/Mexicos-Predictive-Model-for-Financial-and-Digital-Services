...
let description_list = {"1": "<p>Digital inclusion tells us how likely is for a family to have access to electronics and digital services. <br> Overall, the ranking represents an average for all the services included, which are shown on the graphs below. It is very important to mention that most of the families have access to at least one TV and a cellphone, no matter the type of population. <br> Furthermore, only Mexico City achieves a score near 7, which might look good, but it shows the overall setback the country currently has.</p>",
...
'Cuentas_Trad_dem', 'Streaming':'VPH_SPMVPI', 'Personal Credit (dem)': 'Personal_dem', 'Television':'VPH_TV', 'Credit Card':'T_cred_dem',
'Debit Card':'T_debito_dem','Mobile Banking':'Contratos_BM_dem',}
